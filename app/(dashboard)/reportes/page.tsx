                ...
                <table className="min-w-full table-auto border-collapse border border-gray-300">
                  <thead>
                    <tr className="bg-gray-100 text-gray-700">
                      <th className="border border-gray-300 px-3 py-1">Fecha</th>
                      <th className="border border-gray-300 px-3 py-1">Ticket</th>
                      <th className="border border-gray-300 px-3 py-1">Cliente</th>
                      <th className="border border-gray-300 px-3 py-1">Técnico</th>
                      <th className="border border-gray-300 px-3 py-1">Hora Llegada</th>
                      <th className="border border-gray-300 px-3 py-1">Hora Salida</th>
                      <th className="border border-gray-300 px-3 py-1">Horas</th>
                      <th className="border border-gray-300 px-3 py-1">Servicio</th>
                      <th className="border border-gray-300 px-3 py-1">Modalidad</th>
                      <th className="border border-gray-300 px-3 py-1">Tipo Horas</th>
                      <th className="border border-gray-300 px-3 py-1">Monto</th>
                      <th className="border border-gray-300 px-3 py-1">Comisión</th>
                      <th className="border border-gray-300 px-3 py-1">Descripción</th>
                      <th className="border border-gray-300 px-3 py-1">Venta</th>
                    </tr>
                  </thead>
                  <tbody>
                    {modalPreview.data.map((bit) => (
                      <tr key={bit.id} className="even:bg-gray-50">
                        <td className="border border-gray-300 px-2 py-1 text-center">{formatearFecha(bit.fecha)}</td>
                        <td className="border border-gray-300 px-2 py-1 text-center">{bit.ticket}</td>
                        <td className="border border-gray-300 px-2 py-1">{bit.cliente}</td>
                        <td className="border border-gray-300 px-2 py-1">{bit.tecnico}</td>
                        <td className="border border-gray-300 px-2 py-1 text-center">{formatearHora(bit.hora_llegada)}</td>
                        <td className="border border-gray-300 px-2 py-1 text-center">{formatearHora(bit.hora_salida)}</td>
                        <td className="border border-gray-300 px-2 py-1 text-center">{bit.horas}</td>
                        <td className="border border-gray-300 px-2 py-1">{bit.servicio}</td>
                        <td className="border border-gray-300 px-2 py-1">{bit.modalidad}</td>
                        <td className="border border-gray-300 px-2 py-1">{bit.tipo_horas}</td>
                        <td className="border border-gray-300 px-2 py-1 text-right">{bit.monto}</td>
                        <td className="border border-gray-300 px-2 py-1 text-right">{bit.comision}</td>
                        <td className="border border-gray-300 px-2 py-1">{bit.descripcion}</td>
                        <td className="border border-gray-300 px-2 py-1 text-right">{bit.venta}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
