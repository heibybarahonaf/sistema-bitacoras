      ...
      <div className="mb-4">
        ...
        <div className="mt-2 flex gap-2">
          <button
            ...
            disabled={cargando}
            className="bg-blue-600 text-xs text-white px-4 py-2 rounded hover:bg-blue-700"
          >
          ...
          {editandoId && (
            <button
              onClick={cancelar}
              className="bg-gray-400 text-xs text-white px-4 py-2 rounded hover:bg-gray-500"
            >
              Cancelar
            </button>
          )}
